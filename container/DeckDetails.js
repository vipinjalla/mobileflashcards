...
export class DeckDetails extends React.Component {
  ...
  renderQuizButton = (questions=[]) => {
    ...
    return (
      <BoxButton label={' Start Quiz'} type={buttonType.INFO} onPress={() => this.props.navigation.navigate('Quiz')} />
    );
  }
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <BoxButton label={' Add Question'} type={buttonType.ACTION} onPress={() => this.props.navigation.navigate('NewQuestion')} />
